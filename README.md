...
Esta ferramenta foi desenvolvida durante a Formação Análise de Dados com Excel e IA do curso da DIO. 
Ela serve para auxiliar no controle de investimentos, proporcionando uma visão clara e organizada do desempenho da carteira.
